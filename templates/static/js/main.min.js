 ...
 * 2013/07/02
 **/
;(function(b,a){var e=b(a);var c={gap:0,horizontal:false,isFixed:b.noop};var d=function(f){var h=["","-webkit-","-moz-","-ms-","-o-"],g;while(g=h.pop()){f.style.cssText="position:"+g+"sticky";if(f.style.position!==""){return true}}return false};b.fn.fixer=function(g){g=b.extend({},c,g);var h=g.horizontal,f=h?"left":"top";return this.each(function(){var i=this.style,k=b(this),j=k.parent();if(d(this)){i[f]=g.gap+"px";return}e.on("scroll",function(){var o=e[h?"scrollLeft":"scrollTop"](),l=k[h?"outerWidth":"outerHeight"](),n=j.offset()[f],m=j[h?"outerWidth":"outerHeight"]();if(o>=n-g.gap&&(m+n-g.gap)>=(o+l)){i.position="fixed";i[f]=g.gap+"px";g.isFixed()}else{if(o<n){i.position="absolute";i[f]=0}else{i.position="absolute";i[f]=m-l+"px"}}}).resize()})}}(jQuery,this));