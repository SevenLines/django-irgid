...
urlpatterns = i18n_patterns('excursions.views',
    ...
    url(r'image/(?P<pk>(\d+))/remove$', 'ajax.excursion_image_remove', name='ajax_image_remove'),
    url(r'image/(?P<pk>(\d+))/toggle$', 'ajax.excursion_image_toggle', name='ajax_image_toggle'),
